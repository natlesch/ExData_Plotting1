...
#plot upper left
with(bulkDS, plot(combinedDateTime, globalActivePower, type="l", xlab=NA, ylab="Global Active Power"))

#plot upper right
with(bulkDS, plot(combinedDateTime, Voltage, type="l", xlab=NA, ylab="Voltage"))
...
legend("topright", lty=c(1,1,1),col=c("black","red","blue"), legend=c("subMetering1","subMetering2","subMetering3"), bty = "n")

#plot lower right
with(bulkDS, plot(combinedDateTime, globalReactivePower, type="l", xlab=NA, ylab="Global Reactive Power"))
